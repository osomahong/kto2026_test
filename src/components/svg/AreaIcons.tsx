...
const icons: Record<Dimension, React.ReactNode> = {
  dataCollection: (
    <svg viewBox="0 0 40 40" className="w-10 h-10" role="img" aria-label="데이터 수집">
      ...
      <rect x="16" y="10" width="8" height="26" rx="2" fill="#00cc33" />
  ...
  analyticsTools: (
    <svg viewBox="0 0 40 40" className="w-10 h-10" role="img" aria-label="분석 도구">
      <rect x="4" y="4" width="32" height="24" rx="4" fill="#d0ffd6" stroke="#00cc33" strokeWidth="1.5" />
      <line x1="10" y1="22" x2="14" y2="16" stroke="#00cc33" strokeWidth="2" strokeLinecap="round" />
      <line x1="14" y1="16" x2="20" y2="20" stroke="#00cc33" strokeWidth="2" strokeLinecap="round" />
  ...
  campaignExperience: (
    <svg viewBox="0 0 40 40" className="w-10 h-10" role="img" aria-label="마케팅 캠페인">
      <circle cx="20" cy="20" r="14" fill="none" stroke="#d0ffd6" strokeWidth="3" />
      <circle cx="20" cy="20" r="9" fill="none" stroke="#a5c4f7" strokeWidth="3" />
      <circle cx="20" cy="20" r="4" fill="#00cc33" />
  ...
  aiAdoption: (
    <svg viewBox="0 0 40 40" className="w-10 h-10" role="img" aria-label="AI 활용">
      <circle cx="20" cy="10" r="5" fill="#00cc33" />
      <circle cx="8" cy="30" r="5" fill="#a5c4f7" />
      <circle cx="32" cy="30" r="5" fill="#a5c4f7" />
      <line x1="20" y1="15" x2="10" y2="26" stroke="#00cc33" strokeWidth="1.5" strokeDasharray="3 2" />
      <line x1="20" y1="15" x2="30" y2="26" stroke="#00cc33" strokeWidth="1.5" strokeDasharray="3 2" />
