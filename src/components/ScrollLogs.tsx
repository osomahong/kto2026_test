...
const programSteps = [
  ...
  "[STEP_05] 성과 평가 및 우수 사례집 작성",
  "[DETAIL] GA4 · GTM · BigQuery · Looker Studio 환경 구축",
  "[DETAIL] 이벤트 데이터 수집 설계 및 정합성 검증",
  "[DETAIL] KPI 맞춤 시각화 대시보드 제작",
  "[DETAIL] A/B 테스트 기반 캠페인 3회 기획·운영",
